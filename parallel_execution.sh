...
singularity exec LogCoCo_Java8.sif java -jar ./target/logcoco-preprocesslog-1.0-SNAPSHOT.jar "$TARGET_MODULE" "${TARGET_DIR}/log.txt" "${TARGET_DIR}" "${TARGET_ROOT_PATH}/outputClass.txt"
